      ...
      <el-form ref="form" :model="form" label-width="120px" :rules="ruleForm" label-position="left">
        <div v-if="!secondStep">
          ...
          <el-form-item label="手机号" prop="suloginphone">
            <el-input v-model="form.suloginphone"></el-input>
          </el-form-item>
          ...
          <el-form-item label="供应商联系电话" prop="sulinkphone">
            <el-input v-model="form.sulinkphone"></el-input>
          </el-form-item>
        ...
        <div v-else>
          <el-form-item label="银行卡号" prop="subanksn">
            <el-input v-model="form.subanksn"></el-input>
          </el-form-item>
          ...
          <el-form-item label="注册时间" prop="suregisteredtime">
            <el-input v-model="form.suregisteredtime"></el-input>
          </el-form-item>
